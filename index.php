...
// insert (validation ) , update note , update staus , delete
?>
<body>
        ...
        <div class="row d-flex justify-content-between">   
            ...
            <div class="col-md-3 "> 
                ...
                <div class="m-2  py-3">
                    ...
                    <?php
                      $stm =   $conn->query("select * from todolist where `status`='all' order By id desc");
                     if($stm->rowCount()>0){
            ...
            <div class="col-md-3 ">
                ...
                <div class="m-2 py-3">
                    ...
                    <?php
                    $stm =  $conn->query("select * from todolist where status='doing'");
            ...
            <div class="col-md-3">
                ...
                <div class="m-2 py-3">
                    <div class="show-to-do">
                            ...
                            <?php
                    $stm =  $conn->query("select * from todolist where status='done'");
